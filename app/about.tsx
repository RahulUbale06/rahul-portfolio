  ...
  return (
    ...
    >
      ...
      <div className="relative overflow-hidden rounded-3xl border border-blue-500/20 bg-slate-900/35 p-8 shadow-[0_0_50px_rgba(37,99,235,0.12)] backdrop-blur-2xl sm:p-10 lg:p-12">
        ...
        <h2
          id="about-heading"
          className="mt-4 max-w-4xl text-3xl font-semibold leading-tight tracking-tight text-white sm:text-4xl lg:text-[2.8rem]"
        >
        ...
        {/* Main Description */}
        <p className="mt-8 max-w-3xl text-base leading-relaxed text-slate-300 sm:text-lg lg:text-[1.1rem]">
        ...
        <div className="mt-10 grid grid-cols-2 gap-4 sm:grid-cols-4">
          <div className="rounded-2xl border border-blue-500/15 bg-white/[0.03] p-5 text-center transition-all duration-300 hover:border-blue-400/40 hover:bg-blue-500/[0.08]">
